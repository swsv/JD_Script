...
[task_local]
#京东压岁钱
20 8,12 * * * https://raw.githubusercontent.com/swsv/JD_Script/master/QuantumultX/jd_newYearmoeny.js, tag=京东压岁钱, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "20 8,12 * * *" script-path=https://raw.githubusercontent.com/swsv/JD_Script/master/QuantumultX/jd_newYearmoeny.js, tag=京东压岁钱

===============Surge=================
京东压岁钱 = type=cron,cronexp="20 8,12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/swsv/JD_Script/master/QuantumultX/jd_newYearmoeny.js

============小火箭=========
京东压岁钱 = type=cron,script-path=https://raw.githubusercontent.com/swsv/JD_Script/master/QuantumultX/jd_newYearmoeny.js, cronexpr="20 8,12 * * *", timeout=3600, enable=true
 */
...
const inviteCodes = [
  `oMZeLr0x2dkFQYpDRewvsxZy-XmSgqOiGhASRDDXPRXO1Ig@_ZA2XeZKqZZSCuUzMrc8s6YMTP0fbP5bsNPAqHxasUMrTw`,
  `oMZeLr0x2dkFQYpDRewvsxZy-XmSgqOiGhASRDDXPRXO1Ig@_ZA2XeZKqZZSCuUzMrc8s6YMTP0fbP5bsNPAqHxasUMrTw`,
  `oMZeLr0x2dkFQYpDRewvsxZy-XmSgqOiGhASRDDXPRXO1Ig@_ZA2XeZKqZZSCuUzMrc8s6YMTP0fbP5bsNPAqHxasUMrTw`,
  `oMZeLr0x2dkFQYpDRewvsxZy-XmSgqOiGhASRDDXPRXO1Ig@_ZA2XeZKqZZSCuUzMrc8s6YMTP0fbP5bsNPAqHxasUMrTw`,
  `oMZeLr0x2dkFQYpDRewvsxZy-XmSgqOiGhASRDDXPRXO1Ig@_ZA2XeZKqZZSCuUzMrc8s6YMTP0fbP5bsNPAqHxasUMrTw`,
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.shareCodesArr[$.index - 1]) {
      ...
      console.log(`由于您修改了坑逼脚本,避免白嫖助力次数，该脚本将自我助力\n`)
